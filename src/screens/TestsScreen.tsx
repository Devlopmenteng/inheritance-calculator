...
const categories = [
  ...
  {
    key: 'grandfatherWithSiblings',
    label: 'الجد مع الإخوة',
            ...
            <Card style={styles.card} mode="elevated">
              ...
              <Card.Content>
                <View style={styles.statsGrid}>
                  <Surface
                    style={[styles.statItem, { backgroundColor: '#E8F5E9' }]}
                  >
                  ...
                  <Surface
                    style={[styles.statItem, { backgroundColor: '#FFEBEE' }]}
                  >
                  ...
                  <Surface
                    style={[styles.statItem, { backgroundColor: '#E3F2FD' }]}
                  >
                  ...
                  <Surface
                    style={[styles.statItem, { backgroundColor: '#F3E5F5' }]}
                  >
                    ...
                    <View
                      style={[
                        styles.progressFill,
                        {
                          ...
                          backgroundColor:
                            results.failed === 0 ? '#1B5E20' : '#F9A825',
                        },
                      ]}
                    />
                  </View>
            ...
            <Card style={styles.card} mode="elevated">
              ...
              <Card.Content>
                {categories.map((category) => {
                  const categoryTests = results.results.filter(
                      ...
                      >
                        ...
                        <Text
                          style={[
                            ...
                            { color: passed === total ? '#1B5E20' : '#C62828' },
                          ]}
                        >
                          {' '}
                          ({passed}/{total})
